    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "AppUsers",
                columns: new[] { "Id", "CreatedDate", "Email", "IsAdmin", "Name", "Password", "Phone1", "Phone2", "UserGuid" },
                values: new object[] { 1, new DateTime(2025, 3, 13, 14, 56, 0, 483, DateTimeKind.Local).AddTicks(4334), "deneme@gmail.com", true, "Yalçın GÜNEY", "2121", "1111111111", "22222222222", new Guid("a1e546a1-b2af-43b2-abc4-d72ed470c5dc") });

            migrationBuilder.CreateIndex(
                name: "IX_Comments_GaleryId",
                table: "Comments",
                column: "GaleryId");
        }
